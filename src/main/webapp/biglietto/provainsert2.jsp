			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteInsertBigliettoServlet" class="row g-3" >
							...
							<div class="col-12">
								<button type="submit" class="btn btn-primary" onclick="return validateForm()">Conferma</button>
							</div>
